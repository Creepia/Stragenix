...
def submit():
    ...
    get_indicator_func = "import AutoTestback as atb\n"+request.form.get("get_indicator_func")
    get_signal_func = "import AutoTestback as atb\n"+request.form.get("get_signal_func")
